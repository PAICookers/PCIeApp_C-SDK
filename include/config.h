...
# define IRQ_STATUS_REG_OFFSET   (0x00)  /* Interrupt status register */
# define IRQ_CONTROL_REG_OFFSET  (0x04)  /* Interrupt control register */
# define FPGA_MODE_REG_OFFSET    (0x08)  /* Mode status register */
# define TX_REG_OFFSET           (0x0C)  /* TX status register */
# define RX_REG_OFFSET           (0x10)  /* RX status register */
...
# define TX_REG_OFFSET   4   /* TX status register */ 
# define TICK_OFFSET     8   /* Not used */
# define RX_REG_OFFSET   12  /* RX status register */ 
